...
class Auth extends ShieldAuth
{
    ...
    public array $tables = [
        'users'             => 'shield_users',
        'identities'        => 'shield_auth_identities',
        'logins'            => 'shield_auth_logins',
        'token_logins'      => 'shield_auth_token_logins',
        'activation_tokens' => 'shield_auth_activation_tokens',
        'reset_tokens'      => 'shield_auth_reset_tokens',
        'groups_users'      => 'shield_auth_groups_users',
        'permissions_users' => 'shield_auth_permissions_users',
        'remember_tokens'   => 'shield_auth_remember_tokens',
    ];
